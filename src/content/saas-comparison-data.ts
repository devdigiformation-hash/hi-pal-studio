...
export const SAAS_COMPARISONS: SaasReplacementItem[] = [
  ...
  },
  {
    ...
    category: "Creative & Media",
    saasTool: "Adobe Podcast AI & Krisp AI",
    saasVendor: "Adobe / Krisp",
    monthlyCost: 12,
    annualCost: 144,
    costLabel: "$12/mo ($144/yr)",
    digiFeature: "AI Audio Denoise, Noise Cleanup & Voice Isolation",
    digiModule: "Digi Studio",
    digiCost: "100% Free (Included)",
    highlights: [
      "One-click background traffic, fan noise, and machine hiss removal",
      "FFT spectral filtering + dynamic loudness normalization for clear vocals",
      "Unlimited audio file length with zero per-minute cloud rendering caps",
    ],
  },
  {
    id: "vocal-remover",
    category: "Creative & Media",
    saasTool: "Lalal.ai & Moises Pro",
    saasVendor: "Lalal.ai / Moises",
    monthlyCost: 10,
    annualCost: 120,
    costLabel: "$10/mo ($120/yr)",
    digiFeature: "Vocal Isolation & Background Music Remover",
    digiModule: "Digi Studio",
    digiCost: "100% Free (Included)",
    highlights: [
      "Stereo center-channel phase cancellation for instant karaoke tracks",
      "Isolate clean speech or extract instrumental background music",
      "Zero upload queue lag or audio fidelity downsampling",
    ],
  },
  {
    id: "course-transcript-generator",
    category: "Creative & Media",
    saasTool: "Otter.ai Business & NoteGPT",
    saasVendor: "Otter.ai / NoteGPT",
    monthlyCost: 15,
    annualCost: 180,
    costLabel: "$15/mo ($180/yr)",
    digiFeature: "Link-to-Course & Video Transcript Intelligence",
    digiModule: "Digi Studio",
    digiCost: "100% Free (Included)",
    highlights: [
      "Auto-fetches YouTube links and 25-hour playlists without downloading files",
      "Generates full transcripts, multi-module course syllabi, and study notes",
      "One-click export to branded PDF, Markdown, and TXT",
    ],
  },
  {
    id: "document-audiobook",
    category: "Creative & Media",
    saasTool: "Speechify Premium & NaturalReader",
    saasVendor: "Speechify / NaturalSoft",
    monthlyCost: 12,
    annualCost: 139,
    costLabel: "~$12/mo ($139/yr)",
    digiFeature: "Document-to-Audiobook & Multilingual Voice Factory",
    digiModule: "Digi Studio",
    digiCost: "100% Free (Included)",
    highlights: [
      "Convert PDF, DOCX, TXT, or CSV into multi-chapter audiobooks",
      "Unlimited neural voices in Urdu, Hindi, English, Arabic, Persian, French",
      "Zero character limits, zero monthly quotas, downloadable MP3s",
    ],
  },
  {
    id: "social-media-scheduler",
    category: "Marketing & Sales",
    saasTool: "Buffer Team & Hootsuite Starter",
    saasVendor: "Buffer / Hootsuite",
    monthlyCost: 20,
    annualCost: 240,
    costLabel: "$20/mo ($240/yr)",
    digiFeature: "8-Platform Social Switchboard & Calendar Queue",
    digiModule: "Digi Marketing",
    digiCost: "100% Free (Included)",
    highlights: [
      "Post to Facebook, LinkedIn, X, Telegram, Instagram & YouTube in 1 click",
      "Unicode Mathematical Bold/Italic formatting that survives across feeds",
      "Automated publishing queue, draft persistence, and campaign logs",
    ],
  },
];
