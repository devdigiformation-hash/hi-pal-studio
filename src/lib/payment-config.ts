...
export const PLANS: Record<PlanId, Plan> = {
  lifetime: {
    ...
    blurb: "Pay once. Own DIGI BIZ OS for life. Includes 1 month free support and updates.",
    pricePkr: 18000,
    priceUsd: 64,
    priceGbp: 50,
    compareGbp: 69,
    compareUsd: 88,
    comparePkr: 25000,
    billingNote: "One-time payment · 1 month support included · Optional £5/mo ongoing maintenance after month 1",
    includes: [
      "One-time payment — no monthly software lock-in",
      "Lifetime access to DIGI BIZ OS Gen 2",
      "1 month free support & updates included",
      "Optional ongoing maintenance: £5/month after month 1",
  ...
  custom_build: {
    ...
    blurb:
      "Done-for-you software installation, API configuration, WhatsApp AI sales agent, and 5 custom automated business workflows tailored to your operations.",
    pricePkr: 36000,
    priceUsd: 130,
    priceGbp: 100,
    compareGbp: 150,
    ...
    includes: [
      ...
      "5 custom automated business workflows built specifically for your business",
