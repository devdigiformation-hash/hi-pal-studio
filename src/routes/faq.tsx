...
const GROUPS: { heading: string; items: { q: string; a: string }[] }[] = [
  {
    ...
    items: [
      ...
      },
      {
        ...
        a: "It ships with 500+ AI skills and 150+ mixed tools, multi-agent runs, a coding workspace, document processing, browser and file operations, custom memories and workflows.",
      },
      {
