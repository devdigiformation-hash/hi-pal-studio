  ...
  head: () => ({
    meta: [
      ...
      { name: "theme-color", content: "#020408" },
      {
        ...
        content: "_v3UGkPDEE54ZOLLZWhPAWUyjaWxtOyvexkn-x2sbeY",
      },
      {
        name: "google-site-verification",
        content: "google1391ad471043006f",
      },
      {
        name: "google-site-verification",
    ...
    scripts: [
      {
        ...
        children: JSON.stringify({
          ...
          image: "https://www.digibizos.co.uk/logo-512.png",
          sameAs: [
      ...
      },
      {
        ...
        children: JSON.stringify({
          "@context": "https://schema.org",
          "@type": "WebSite",
          "@id": "https://www.digibizos.co.uk/#website",
          name: "DIGI BIZ OS",
          alternateName: ["DigiBiz OS", "DIGIBIZOS", "DIGI BIZ OS Windows"],
          inLanguage: "en-GB",
          url: "https://www.digibizos.co.uk",
          publisher: { "@id": "https://www.digibizos.co.uk/#organization" },
          potentialAction: {
            "@type": "SearchAction",
            target: {
              "@type": "EntryPoint",
              urlTemplate: "https://www.digibizos.co.uk/search?q={search_term_string}",
            },
      ...
      },
      {
        ...
        children: JSON.stringify(
          [
            ...
            isPartOf: { "@id": "https://www.digibizos.co.uk/#website" },
          })),
        ),
      },
    ],
