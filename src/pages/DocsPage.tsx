...
const CARDS = [
  ...
  },
  {
    ...
    body: "Complete reference for 150+ mixed tools, 500+ skills and 100+ offline utilities, with plain-language descriptions and examples.",
    cta: "View Reference →",
    primary: false,
  },
  {
          ...
          <GlassCard className="reveal-item delay-2 mt-10">
            <TerminalBlock
              ...
              lines={[
                ...
                { text: "> 500+ AI skills · 150+ mixed tools loaded", color: "var(--cyan)" },
