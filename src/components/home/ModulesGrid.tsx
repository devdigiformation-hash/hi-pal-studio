...
const MODULES: Module[] = [
  ...
  },
  {
    ...
    body: "Automated 20-stage product and supplier hunting across Amazon, eBay, Etsy, Walmart, TikTok, and Shopify with historical research tracking.",
    bullets: [
      "20-stage deep market analysis",
      "Multi-platform competitor research",
      "Supplier & margin discovery",
    ],
