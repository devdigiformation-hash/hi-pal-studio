...
const COPY: Record<Tab, { title: string; body: string; badges: string[]; bullets: string[] }> = {
  ...
  Automation: {
    title: "Workflows + Always-On Rules",
    body: "Autonomous workflow automation with always-on business monitors, scheduled cron triggers, and fail-safe step-by-step task execution.",
    badges: ["Always-On Rules", "Cron Jobs", "Flow Builder"],
    bullets: [
      "Always-on background monitors",
      "Overdue invoice & stock alerts",
      "Multi-agent task delegation",
      "Fail-safe step-by-step runner",
    ],
  },
  Connectivity: {
    title: "Channels Hub",
    body: "Unified WhatsApp QR agent, incoming/outgoing email, Telegram bots, Slack, Discord and universal MCP tool servers—configured and monitored live.",
    badges: ["WhatsApp QR", "Email IMAP/SMTP", "Universal MCP", "Telegram Bot"],
    bullets: [
      "One unified inbox across channels",
      "Autonomous WhatsApp sales agent",
  ...
  Developer: {
    title: "CLI + MCP",
    body: "Digi CLI custom command execution with live streaming output, pre-integrated offline engines (FFmpeg, Whisper, DuckDB, Typst), and universal stdio MCP client.",
