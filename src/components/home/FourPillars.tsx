...
const PILLARS: Pillar[] = [
  {
    ...
    body: "Continuous 2-way Gemini Live speech streaming. Speak naturally — your desktop responds in <200ms. No more typing. Just talk.",
    badge: "Gemini Live · PCM 16kHz → 24kHz",
    bullets: [
  ...
  },
  {
    ...
    body: "Stream 960px resolution frames directly into Gemini reasoning models. Your AI sees what you see — enabling live QA, code review, and visual analysis.",
