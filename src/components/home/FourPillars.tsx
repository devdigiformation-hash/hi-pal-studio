...
const PILLARS: Pillar[] = [
  {
    icon: Mic,
    color: "var(--cyan)",
    title: "Intelligent Business Voice Assistant",
    body: "Continuous 2-way speech intelligence. Speak naturally to review WhatsApp customer chats, pending UK LTD & US LLC orders, identity verification checkpoints, and daily operational priorities in <200ms.",
    badge: "Daily Operational Assistant",
    bullets: [
      "WhatsApp & order follow-up triage",
      "Contextual reminders & priority scheduling",
      "Sub-200ms local Whisper speech pipeline",
    ],
    wave: true,
  },
  {
    ...
    bullets: [
      ...
      "Clipboard, brightness, power & app control",
    ],
  },
  {
    icon: Eye,
    ...
    body: "Share your screen or camera and DIGI BIZ OS sees exactly what you see — live review, screenshot understanding and instant visual analysis.",
    badge: "Screen Sharing · Camera Support",
    bullets: ["Live screen sharing", "Screenshot understanding", "Webcam multimodal input"],
  },
  {
    icon: Network,
    color: "var(--pink)",
      ...
      <div className="mx-auto max-w-[1280px]">
        <div className="text-center">
          ...
          <h2 className="reveal-item delay-1 mt-4 font-display text-[34px] font-bold tracking-[-0.03em] text-[var(--text-primary)] md:text-[48px]">
            Four Engines.{" "}
            <GradientText from="#2FE0C8" to="#4DA3FF">
              One Unstoppable OS.
            </GradientText>
          </h2>
