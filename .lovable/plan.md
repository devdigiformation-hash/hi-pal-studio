# Plan: Add Agency Orchestrator Sub-page

Create a dedicated sub-page for "Agency Orchestrator" in the Open-Source Free Business Tools section, following the existing theme and structure.
...
- `src/routes/open-source.agency-orchestrator.tsx` (New)
- `src/routes/open-source.index.tsx` (Edit)
- `src/routes/sitemap.tsx` (Edit)
